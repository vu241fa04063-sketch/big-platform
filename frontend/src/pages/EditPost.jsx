...
export default function EditPost() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setServerError(err.response?.data?.message || 'Failed to update post.');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (fetching) {
    return (
      <div className="post-form-page container">
        <div className="post-form__loading" role="status">
        ...
        <form onSubmit={handleSubmit} className="post-form" noValidate>
          ...
          <div className="form-group">
            <label htmlFor="excerpt" className="form-label">
              Excerpt <span className="form-label--optional">(optional)</span>
            </label>
            <textarea
              id="excerpt"
              name="excerpt"
